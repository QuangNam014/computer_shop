...
class AdminCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.components.category.index', compact('categories'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.components.category.create', compact('optionHtml'));
    }
    ...
    public function edit(Category $category)
    {
        ...
        return view('backend.components.category.edit', compact('optionHtml','category'));
    }
