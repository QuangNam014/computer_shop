...
class AdminMenuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.components.menu.index', compact('menus'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.components.menu.create', compact('optionHtml'));
    }
    ...
    public function edit(Menu $menu)
    {
        ...
        return view('backend.components.menu.edit', compact('optionHtml', 'menu'));
    }
