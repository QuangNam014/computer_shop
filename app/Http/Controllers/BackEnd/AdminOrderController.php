...
class AdminOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("backend.components.order.index", compact('orders'));
    }
    ...
    public function show(Order $order)
    {
        ...
        return view("backend.components.order.detail", compact('order','productItem'));
    ...
    public function search(Request $request) {
        ...
        return view('backend.components.order.search', compact('orders'));
    }
