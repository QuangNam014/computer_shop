...
class AdminProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.components.product.create', compact('optionHtml','types'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        return view('backend.components.product.edit', compact('optionHtml','product','types'));
    }
    ...
    public function search(Request $request) {
        ...
        return view('backend.components.product.search', compact('products'));
    }
}
