...
class AdminSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.components.setting.index', compact('settings'));
    }
    ...
    {
        return view('backend.components.setting.create');
    }
    ...
    {
        return view('backend.components.setting.edit', compact('setting'));
    }
