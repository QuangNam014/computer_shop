...
class AdminSliderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.components.slider.index', compact('sliders'));
    }
    ...
    {
        return view('backend.components.slider.create');
    }
    ...
    {
        return view('backend.components.slider.edit', compact('slider'));
    }
