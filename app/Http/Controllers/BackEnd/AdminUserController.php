...
class AdminUserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.components.user.index',compact('users'));
    }
    ...
    {
        return view('backend.components.user.detail',compact('user'));
    }
    ...
    {
        return view('backend.components.user.edit',compact('user'));
    }
    ...
    public function search(Request $request) {
        ...
        return view('backend.components.user.search', compact('users'));
    }
}
